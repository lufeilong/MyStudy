...
public class ExcelUtilCopy {
	...
	private static final Logger logger = LoggerFactory.getLogger(ExcelUtilCopy.class);
    ...
    public <T> void exportDataToExcelMe(List<T> list,String[] headers,String title,OutputStream os){
        ...
        sheet.setDefaultColumnWidth(15);
        //生成一个样式
        XSSFCellStyle style = this.getCellStyle(workbook);
        //生成一个字体
...
//        style.setFillForegroundColor(XSSFColor.GREY_25_PERCENT.index);
        ...
        style.setLeftBorderColor(XSSFCellStyle.BORDER_THIN);
        style.setRightBorderColor(XSSFCellStyle.BORDER_THIN);
    ...
    public XSSFFont getFont(XSSFWorkbook workbook){
    	...
    	font.setColor(XSSFColor.toXSSFColor((org.apache.poi.ss.usermodel.Color) Color.WHITE));
        font.setFontHeightInPoints((short)12);
